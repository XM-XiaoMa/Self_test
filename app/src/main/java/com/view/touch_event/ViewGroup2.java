...
public class ViewGroup2 extends LinearLayout {
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        Log.d("xiaoma", "ViewFroup2 dispatchTouchEvent == " + ev.getAction());
        return super.dispatchTouchEvent(ev);
    }

    @Override
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.d("xiaoma", "ViewFroup2 onInterceptTouchEvent == " + ev.getAction());
        return super.onInterceptTouchEvent(ev);
    }

    @Override
    public boolean onTouchEvent(MotionEvent event) {
        Log.d("xiaoma", "ViewFroup2 onTouchEvent == " + event.getAction());
